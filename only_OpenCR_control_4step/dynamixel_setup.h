...
// Function declarations
  public:
    ...
    void motor_address();
    void motor_torque();
    void head_groupSyncWrite(uint8_t position_velocity[16]);
    void motor_groupSyncWrite(uint8_t position_velocity[208]);
    void tranfer_bit(uint8_t position_velocity[208]);
    ...
    int relative_position[12] = {10000, 0, 0, 4000, 0, 0, -10000, 0, 0, 0, 0, 0};
